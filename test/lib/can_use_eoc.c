...
void test_can_use_eoc_v1(void **state)
{
    (void)state;             
...
void test_can_use_eoc_v2(void **state)
{
    (void)state;             
    info_s* infos=malloc(sizeof(info_s));
    infos->mode=STEGX_MODE_INSERT;
...
void test_can_use_eoc_v3(void **state)
{
    (void)state;             
    info_s* infos=malloc(sizeof(info_s));
    infos->mode=STEGX_MODE_INSERT;
...
void test_can_use_eoc_v4(void **state)
{
    (void)state;             
    info_s* infos=malloc(sizeof(info_s));
    infos->mode=STEGX_MODE_INSERT;
...
void test_can_use_eoc_v5(void **state)
{
    (void)state;             
    info_s* infos=malloc(sizeof(info_s));
    infos->mode=STEGX_MODE_INSERT;
...
void test_can_use_eoc_v6(void **state)
{
    (void)state;             
    info_s* infos=malloc(sizeof(info_s));
    infos->mode=STEGX_MODE_INSERT;
...
void test_can_use_eoc_v7(void **state)
{
    (void)state;             
    info_s* infos=malloc(sizeof(info_s));
    infos->mode=STEGX_MODE_INSERT;
...
void test_can_use_eoc_v8(void **state)
{
    (void)state;             
    info_s* infos=malloc(sizeof(info_s));
    infos->mode=STEGX_MODE_INSERT;
...
void test_can_use_eoc_v9(void **state)
{
    (void)state;             
    info_s* infos=malloc(sizeof(info_s));
    infos->mode=STEGX_MODE_INSERT;
...
const struct CMUnitTest suggest_algos_tests[] = {
    ...
    cmocka_unit_test(test_can_use_eoc_v1),
    cmocka_unit_test(test_can_use_eoc_v2),
    cmocka_unit_test(test_can_use_eoc_v3),
    cmocka_unit_test(test_can_use_eoc_v4),
    cmocka_unit_test(test_can_use_eoc_v5),
    cmocka_unit_test(test_can_use_eoc_v6),
    cmocka_unit_test(test_can_use_eoc_v7),
    cmocka_unit_test(test_can_use_eoc_v8),
    cmocka_unit_test(test_can_use_eoc_v9),
