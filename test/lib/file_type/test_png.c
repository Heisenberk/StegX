...
void test_metadata_png_without_passwd(void **state)
{
	...
	strcpy(choices_insert->host_path,"../../../env/test/test9.png");
	choices_insert->res_path=malloc((strlen("./short.txt")+1)*sizeof(char));
	strcpy(choices_insert->res_path,"./res2_test_metadata.png");
	...
	stegx_choices_s* choices_extract=malloc(sizeof(stegx_choices_s));
	choices_extract->host_path=malloc((strlen("./res2_test_metadata.png")+1)*sizeof(char));
	strcpy(choices_extract->host_path,"./res2_test_metadata.png");
	choices_extract->res_path=malloc((strlen("./")+1)*sizeof(char));
	strcpy(choices_extract->res_path,"./");
