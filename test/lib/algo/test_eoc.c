...
void test_eoc_protection(void **state)
{
    ...
    choices->host_path = "../../../env/test/flv/test13.flv", assert_non_null(choices->host_path);
    choices->res_path = "./res_test_eoc.flv", assert_non_null(choices->res_path);
    ...
    assert_non_null(choices);
    choices->host_path = "./res_test_eoc.flv", assert_non_null(choices->host_path);
    choices->res_path = "./", assert_non_null(choices->res_path);
...
void test_eoc_no_protection(void **state)
{
    ...
    stegx_choices_s *choices = malloc(sizeof(stegx_choices_s));
    assert_non_null(choices);
    choices->host_path = "../../../env/test/flv/test_20mb.flv", assert_non_null(choices->host_path);
    choices->res_path = "./res_test_eoc.flv", assert_non_null(choices->res_path);
    choices->mode = STEGX_MODE_INSERT;
    choices->passwd = "stegx";
    choices->insert_info = malloc(sizeof(stegx_info_insert_s)),
