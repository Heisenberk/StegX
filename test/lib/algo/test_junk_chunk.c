...
/* Test final de l'insertion/extraction JUNK CHUNK sur un fichier AVI avec 
 * mot de passe 
 **/
void test_junk_chunk_avi_with_passwd(void **state)
{
    (void)state;
    stegx_choices_s *choices_insert = malloc(sizeof(stegx_choices_s));
    choices_insert->host_path =
        malloc((strlen("../../../env/test/avi/test14.avi") + 1) * sizeof(char));
    strcpy(choices_insert->host_path, "../../../env/test/avi/test14.avi");
    choices_insert->res_path = malloc((strlen("./res1_test_junk_chunk.avi") + 1) * sizeof(char));
    strcpy(choices_insert->res_path, "./res1_test_junk_chunk.avi");
    ...
    choices_insert->insert_info->algo = STEGX_ALGO_JUNK_CHUNK;
    int test;
    ...
    choices_extract->host_path = malloc((strlen("./res1_test_junk_chunk.avi") + 1) * sizeof(char));
    strcpy(choices_extract->host_path, "./res1_test_junk_chunk.avi");
...
/* Test final de l'insertion/extraction JUNK CHUNK sur un fichier AVI sans 
 * mot de passe 
 **/
void test_junk_chunk_avi_without_passwd(void **state)
{
    (void)state;
    stegx_choices_s *choices_insert = malloc(sizeof(stegx_choices_s));
    choices_insert->host_path =
        malloc((strlen("../../../env/test/avi/test14.avi") + 1) * sizeof(char));
    strcpy(choices_insert->host_path, "../../../env/test/avi/test14.avi");
    choices_insert->res_path = malloc((strlen("./res2_test_junk_chunk.avi") + 1) * sizeof(char));
    strcpy(choices_insert->res_path, "./res2_test_junk_chunk.avi");
    ...
    stegx_choices_s *choices_extract = malloc(sizeof(stegx_choices_s));
    choices_extract->host_path = malloc((strlen("./res2_test_junk_chunk.avi") + 1) * sizeof(char));
    strcpy(choices_extract->host_path, "./res2_test_junk_chunk.avi");
    choices_extract->res_path = malloc((strlen("./") + 1) * sizeof(char));
    strcpy(choices_extract->res_path, "./");
...
const struct CMUnitTest junk_chunk_tests[] = {
    cmocka_unit_test(test_junk_chunk_avi_with_passwd),
    cmocka_unit_test(test_junk_chunk_avi_without_passwd),
