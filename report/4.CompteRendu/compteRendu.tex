...
% a redefinir plus precisement ave la description des modules
...
Nous avons donc trouvé une solution : l'utilisation de la librairie 
\textit{endian.h} qui permet de convertir un nombre entre 8 et 64 bits 
little/big endian en l'endian de la machine. 
De plus, nous avons recherché à propos des processeurs little/big endian. 
Les processeurs big-endian sont les processeurs pour les systèmes embarqués.

L'utilisateur qui va manipuler StegX va donc avoir une architecture 
little-endian. C'est d'ailleurs l'architecture des ordinateurs utilisés 
par l'équipe de conception StegX. 
