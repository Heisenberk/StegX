...
Au vue de la relative simplicité de la construction de nos structures de 
...
la plupart des applications ; c’est-à-dire les applications où l’on parle 
...
par les classes. La généricité, proposée entre autres par l’héritage de 
classe, la surcharge et les templates sont aussi des fonctionnalités importantes. 
Enfin, la bibliothèque standard du C++ ainsi que la STL propose d’emblée 
une large variété de structure de données ainsi que d’algorithmes génériques. 
