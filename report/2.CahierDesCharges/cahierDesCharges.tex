...
L'application a besoin de structures simples afin de gérer les différents 
formats de fichiers. Elle manipulera des fichiers binaires à l'aide de 
différents algorithmes fonctionnels de stéganographie. Le choix du langage 
purement orienté objet est donc écarté. \newline
Ensuite, l'implémentation du programme devra permettre de réutiliser le code 
à plusieurs emplacements différents dans le logiciel : comme par exemple, 
les algorithmes de stéganographie qui doivent être applicables pour les formats 
pris en charge par l'application.
C'est donc pour cette raison qu'un langage procédural et modulaire sera
le choix le plus efficace. \newline 
Le C, garantissant tous ces critères et étant très performant, 
