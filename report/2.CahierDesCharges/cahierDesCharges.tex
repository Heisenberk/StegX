...
monde multimedia ainsi qu'en stéganographie. 
...
\begin{tabular}{|c|c|c|c|}
  ...
  \hline
    Interface en ligne & 200 & 30 & AYOUB Pierre \& \\ 
    de commande & lignes & heures & DELAUNAY Damien \\
  \hline
  Interface & 300 & 30 & BASKEVITCH Claire \& \\
  graphique & lignes & heures & BESSAC Tristan \\
  \hline
...
%L'étude des besoins de l'application nous indique qu'un langage procédural 
%et modulaire est le choix le plus efficace. 
%Les structures que nous manipulerons seront simples et ne nécessitent pas 
%d'encapsulation. Le C, garantissant tous ces critères et étant très performant, 
%répond à nos besoins. Nous utiliserons donc ce langage pour StegX. \newline
%GTK+, associé au langage C, propose une bibliothèque graphique. Ainsi, 
%nous l'utiliserons pour notre interface graphique. 
Tout d'abord, nous avions plusieurs choix concernant le langage : un langage 
purement procédural, un langage purement orienté objet ou un langage hybride. 
Notre logiciel applique des algorithmes stéganographiques sur des fichiers. 

Notre application a besoin de structures simples afin de gérer les différents 
formats de fichiers. Elle manipulera des fichiers binaires à l'aide de 
différents algorithmes de stéganographie. 
