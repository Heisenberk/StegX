...
\begin{lstlisting}[language=c]
void* stegx_suggest_algo_stegano (info_s* infos);
\end{lstlisting}
...
\begin{lstlisting}[language=c]
void* detect_algo_stegano (info_s* infos); 
\end{lstlisting}

Cette fonction va , à l'aide de la fonction \textit{fill\_host\_file\_type}, 
le champ-union \textit{infos.host.file\_type} sera initialisé. Enfin, cette 
fonction appellera \textit{stegx\_read\_signature\_app} pour connaître les 
