...
\begin{itemize}
\item Compatibilité : le format du fichier contenant les données cachées, choisi par l'utilisateur doit être examiné afin de vérifier sa compatibilité avec l'application. 
