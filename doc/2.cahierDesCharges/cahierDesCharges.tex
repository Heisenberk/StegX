...
\subsection{But du projet} % a revoir
...
Le Cahier des Charges doit être remis le 14 mars. Le Cahier des Spécifications est à remettre le 18 avril. La remise du produit au client est le 25 mai. 
...
Tous les autres ne s'occupent que d'un seul format (souvent que le format image). 
